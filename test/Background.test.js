...
const registered = {
  onCreated: global.browser.bookmarks.onCreated.addListener.mock.calls.length > 0,
  onRemoved: global.browser.bookmarks.onRemoved.addListener.mock.calls.length > 0,
  tabsUpdated: global.browser.tabs.onUpdated.addListener.mock.calls.length > 0,
  tabsActivated: global.browser.tabs.onActivated.addListener.mock.calls.length > 0,
  windowsFocusChanged:
